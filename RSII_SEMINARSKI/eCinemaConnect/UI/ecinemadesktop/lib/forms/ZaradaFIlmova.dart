...
class ZaradaFilmova extends StatefulWidget {
  @override
  _ZaradaFilmovaState createState() => _ZaradaFilmovaState();
}

class _ZaradaFilmovaState extends State<ZaradaFilmova> {
  ...
  Future<void> _exportToPdf() async {
    ...
    try {
      ...
      final fileName =
          'zarada_filma_na_datum_i_vrijeme${DateTime.now().toString().replaceAll(' ', '_').replaceAll(':', '_')}.pdf';
